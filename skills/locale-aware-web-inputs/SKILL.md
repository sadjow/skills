---
name: locale-aware-web-inputs
description: Design or debug locale-aware web inputs for money, dates, phones, postal codes, quantities, and identifiers. Use for formatting, parsing, validation, caret behavior, and preserving authored intent.
---

# Locale-Aware Web Inputs
