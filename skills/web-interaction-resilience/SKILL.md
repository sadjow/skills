---
name: web-interaction-resilience
description: Design web interactions that stay responsive and correct under latency, rapid input, cancellation, and recovery. Use for browser/server state ownership and pending-state behavior.
---

# Web Interaction Resilience
...
critical browser journey with `$playwright-responsive-ui-testing` when available.
