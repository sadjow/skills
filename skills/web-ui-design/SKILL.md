---
name: web-ui-design
description: Design or review web interfaces for clear hierarchy, layout, navigation, responsive behavior, and visual consistency. Use for general web UI work and design systems.
---
