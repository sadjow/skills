...
description: |-
  Develop or review Clojure code using functional idioms, immutable data, REPL workflows, and focused tests. Use for Clojure implementation, debugging, or design decisions.
---
