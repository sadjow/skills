---
name: phoenix-ui-architecture
description: Design or review Phoenix UI structure with HEEx, components, forms, layouts, hooks, and Tailwind. Use for component boundaries and interface composition.
---
