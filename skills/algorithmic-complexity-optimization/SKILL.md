...
description: Find and improve algorithmic performance hotspots, including nested work, repeated queries, and unnecessary recomputation. Use for complexity analysis or behavior-preserving optimization.
---
